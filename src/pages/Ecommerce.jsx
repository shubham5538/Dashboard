    ...
    <div className='mt-12'> 
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          ...
          <div className='mt-6'>
            <Button color='white' bgColor={currentColor} text='Earnings' borderRadius='10px' size='md'/>
        </div>
      </div>
      <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
        {earningData.map((item) => (
          <div key={item.title} className='bg-white dark:text-gray dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl'>
