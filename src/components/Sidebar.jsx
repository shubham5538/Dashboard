...
const Sidebar = () => {
  ...
  const normalLink = 'flex item-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-white dark:text-gray-200 dark:hover:text-black hover:bg-light-yellow m-2';
